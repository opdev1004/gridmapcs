namespace GridMap
{
	...
	{
		public static List<(int, int, string)> MAStarShortestPathAD(List<List<string>> TwoDMap, (int y, int x) start, (int y, int x) goal, List<string> obstacles)
		{
			...
			var fScore = new Dictionary<(int, int), int> { [start] = ManhattanHeuristic(start, goal) };
